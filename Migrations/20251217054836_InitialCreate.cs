        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdLimit = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdsPosted = table.Column<int>(type: "int", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 12, 17, 10, 48, 19, 969, DateTimeKind.Local).AddTicks(118), "Residential houses", "fas fa-house", true, "House" },
                    { 2, new DateTime(2025, 12, 17, 10, 48, 19, 969, DateTimeKind.Local).AddTicks(138), "Flats and apartments", "fas fa-building", true, "Apartment" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2025, 12, 17, 10, 48, 19, 969, DateTimeKind.Local).AddTicks(521), "Free package for basic users", 30, true, "Basic", 0m },
                    { 2, 5, new DateTime(2025, 12, 17, 10, 48, 19, 969, DateTimeKind.Local).AddTicks(528), "Silver package for regular users", 60, true, "Silver", 1000m },
